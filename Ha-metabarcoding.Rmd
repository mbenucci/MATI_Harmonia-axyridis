...
Visually checking the samples showed that 5 samples sequenced with blocking primers didn't pass the QC. In order to run the Mann-Whitney test with paired samples we need to remove the extra samples from the dataset without blocking primers and order the samples.
...
```{r Mann-Whitney test on blocking primers}
