...
plot(meta.guts,type="n", xlim=c(-1,1), ylim=c(-1,1), cex.axis=2, cex.lab=1.5)
...
text(3,1.5,label="Oct", cex=2.5)
text(2.5,-3.7, label=paste0("Stress: ", round(meta.comms$stress, 4)), cex=1.5)
text(-3,2.3, label="b)", cex=3)
text(0,2.3,label="community", cex=2.5)

plot(meta.guts.comms,type="n", xlim=c(-2,5), ylim=c(-2.5,2), cex.axis=2, cex.lab=1.5)
...
text(3,-2.2, label=paste0("Stress: ", round(meta.guts.comms$stress, 4)), cex=1.5)
text(-2.2,1.8, label="c)", cex=3)
text(0,1.8,label="community", cex=2.5)
...
name.multi=c("Aphididae","Acari","Tachinidae","Chironomidae","Chrysomelidae","Ectopsocidae","Psocoptera")
col.multi=c("cyan3","orchid","purple","tan4","black","darkolivegreen4","khaki")

col.prey=c("cyan3","orchid","cyan3","purple","cyan3","black","tan4","darkolivegreen4","khaki")

# no c("orange","yellow","blue","red")

png("R_images/publication_tripartite_network.png", width=6000, height=4000, res=300)
plotweb(web.dc, method="normal", labsize=2, y.lim=c(-0.5,2.7), x.lim=c(0,1.25), adj.high=c(0,-0.5), adj.low=c(0.5,-0.1), y.width.low=0.05, y.width.high=0.1, high.y=2.5, low.y=1.54, low.spacing=0.077, arrow="down", col.low="transparent", bor.col.low="transparent", col.interaction=c("orange","yellow","blue","red"), low.plot=T, empty=F)
plotweb(web.ha, method="normal", labsize=2,  text.rot=90, y.width.low=0.1, y.width.high=0.09,	high.y=1.5, low.y=0.5, low.lab.dis=0.05, high.lablength=0, high.spacing=0.077, low.spacing=0.03, col.high="transparent",  col.interaction=c("orange","yellow","blue","red"), col.low=col.prey, add=T, empty=F)
