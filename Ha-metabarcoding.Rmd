...
```{r order}
web.ha = web.ha[c("Betulaphis","Callipterinella","Clethrobius_comes","Taeniothrips_inconsequens","Thripidae","Trombidiformes_sp._BOLD:ACI3657","Euceraphis","Ocytata_pallipes","Drepanosiphum_platanoidis","Chrysomelidae","Chironomus","Ectopsocus_californicus","Eucallipterus_tiliae","Psocoptera"),]
...
lay.matrix = matrix(c(1,1,2,2,1,1,2,2,3,3,4,0,3,3,3,0), nrow=4, ncol=4, byrow=T)
layout(lay.matrix)
