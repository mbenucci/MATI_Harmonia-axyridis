...
box_a = ggplot(full_blk_melt,(aes(specie_type, value))) +
  ...
  geom_signif(na.rm=T, comparisons=list(c("prey","predator")), test="chisq.test")
...
plot_grid(blk_a, blk_b, labels=c("a)","b)"), ncol=2, nrow=1)
dev.off()
```
...
name.legend=c("Aphididae","Acari","Tachinidae","Chironomidae","Chrysomelidae","Ectopsocidae","Psocoptera")
col.legend=c("cyan3","orchid","purple","tan4","black","darkolivegreen4","khaki")
