...
a<-ggplot(heat_blk_melt[heat_blk_melt$specie %in% c("Drepanosiphum_platanoidis","Pyrrhalta_viburni"),],(aes(pcr, variable))) +
  ...
  #scale_fill_gradient2(low="gray87", high="blue", mid="orange", midpoint=40, na.value="black", limits=c(1,70), name="Normalised\nDNA reads\n") +
  scale_fill_gradientn(colors=c("white","grey87","orange","blue"), values=c(0,0.1,0.5,1), na.value="black", name="Normalised\nDNA reads\n") + 
  theme_classic() +
