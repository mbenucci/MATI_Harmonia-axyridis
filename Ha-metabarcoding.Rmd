...
ggplot(full_blk_melt,(aes(specie_type, log10(value)))) +
  ...
  theme_bw() +
  facet_grid(.~pcr) +
  theme(legend.position="right", legend.title=element_blank(), legend.text=element_text(size=15), axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.text=element_text(size=15), axis.title=element_text(size=15), strip.text=element_text(size=15)) #,plot.margin=unit(c(0.25,0,0.25,0.7), unit="cm"))
dev.off()
```
